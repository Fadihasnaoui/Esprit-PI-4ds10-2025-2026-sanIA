                ...
                >
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <input
                                ...
                                style={{
                                    ...
                                    color: '#fff', fontSize: '1rem', fontFamily: "'Rajdhani', sans-serif",
                                    letterSpacing: '0.5px',
                                }}
                            />
                            <div style={{
                        ...
                        <div style={{ flex: 1, overflowY: 'auto', padding: '10px 8px' }}>
                                            ...
                                            <Row key={`a-${a.id}`}
                                                ...
                                                <div style={{ flex: 1 }}>
                                                    <div style={{ fontWeight: 700 }}>
                                                        {a.tag_id || '—'}
                                                        <span style={{ color: 'rgba(255,255,255,0.45)', marginLeft: 8, fontWeight: 500 }}>
                            ...
                            {totalResults === 0 && (
                                <div style={{ padding: 30, textAlign: 'center', color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem' }}>
...
const SectionTitle = ({ children }) => (
    <div style={{
        ...
        color: 'rgba(255,255,255,0.35)', padding: '8px 12px 4px', fontWeight: 800,
    }}>{children}</div>
);
